...
func (p *ProfileStorage) GetByUserId(userId uint32) (*types.Profile, error) {
...
func (p *ProfileStorage) Create(profile *types.NewProfileRequest) (uint32, error) {
	query := `insert into
...
func (p *ProfileStorage) UpdateProfileByUserID(userId uint32, profile *types.UpdateProfileRequest) error {
