...
var SCHEMA = map[string]string{
	...
	"products":           "id SERIAL PRIMARY KEY, product_id VARCHAR(30) NOT NULL, name VARCHAR(50), slug VARCHAR(50), price INTEGER NOT NULL DEFAULT 0, image VARCHAR(100),  description VARCHAR(300) NOT NULL, category_id INTEGER NOT NULL, created_at TIMESTAMP DEFAULT NOW() NOT NULL, updated_at TIMESTAMP DEFAULT NOW() NOT NULL, deleted_at TIMESTAMP DEFAULT NULL, CONSTRAINT fk_category FOREIGN KEY (category_id) REFERENCES product_categories(id)",
